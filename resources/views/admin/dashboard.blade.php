                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <div class="display-6">{{ $activeUsers ?? 0 }}</div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <div class="display-6">{{ $productsCount ?? 0 }}</div>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row text-center">
                        <div class="col">
                            ...
                            <div class="fs-4">{{ $ordersByStatus['pending'] ?? 0 }}</div>
                        </div>
                        <div class="col">
                            <div class="small text-uppercase">{{ __('messages.paid') }}</div>
                            <div class="fs-4">{{ $ordersByStatus['paid'] ?? 0 }}</div>
                        </div>
                        <div class="col">
                            <div class="small text-uppercase">{{ __('messages.shipped') }}</div>
                            <div class="fs-4">{{ $ordersByStatus['shipped'] ?? 0 }}</div>
                        </div>
                        <div class="col">
                            <div class="small text-uppercase">{{ __('messages.cancelled') }}</div>
                            <div class="fs-4">{{ $ordersByStatus['cancelled'] ?? 0 }}</div>
                        </div>
                    </div>
                </div>
            </div>
