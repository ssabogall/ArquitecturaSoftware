...
return [
    ...
    'compare' => [
        'phones_required' => 'Debes seleccionar teléfonos para comparar.',
        'phones_array' => 'La selección de teléfonos no es válida.',
        'phones_min' => 'Debes seleccionar al menos :min teléfonos para comparar.',
        'phones_max' => 'No puedes comparar más de :max teléfonos a la vez.',
        'phone_id_required' => 'Cada teléfono seleccionado debe ser válido.',
